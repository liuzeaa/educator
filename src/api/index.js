...
//组织机构
// 获取一级部门
export const initOrganizationUnits = (params) => {
    return getRequest('/organizationUnits/getByParentId/0', params)
}
// 加载部门子级数据
export const loadOrganizationUnits = (id, params) => {
    return getRequest(`/organizationUnits/getByParentId/${id}`, params)
}
//加载组织节点成员
export const loadOrganizationUnitsMember=(id,params)=>{
    return getRequest(`/organizationUnits/getMember/${id}`, params)
}
//添加人员到指定的组织节点
export const addMemberToOrganizationUnits=(id,params)=>{
    return postDefaultRequest(`/organizationUnits/addMember/${id}`, params)
}
// 添加部门
export const addOrganizationUnits = (params) => {
    return postRequest('/organizationUnits/add', params)
}
// 编辑部门
export const editOrganizationUnits = (params) => {
    return postRequest('/organizationUnits/edit', params)
}
// 删除部门
export const deleteOrganizationUnits = (ids, params) => {
    return deleteRequest(`/organizationUnits/delByIds/${ids}`, params)
}
